...
import { getList, searchItem } from '../../../store/brand/action'
...
import {clearState} from '../../../store/brand/slice'
...
export default function List(){
    ...
    const actionBodyTemplate = (items) => {
        return (
            <>
            <Link to={`/master/brand/edit/${items.master_brand_id}`} className="p-button role_edit" tooltip="Save" tooltipOptions={{ position: 'bottom', mouseTrack: true, mouseTrackTop: 15 }}> <span className="pi pi-pencil"></span> </Link> &nbsp;
                            ...
                            <div className='col-12'>
                                <div className='card custom-card'>
                                    <div className="card-header">
                                        ...
                                        <Link to="/master/brand/add" className="p-button p-component p-button-rounded p-button-success" style={{float:'right'}} > <span className="pi pi-plus"></span> Add New</Link>
                                    </div>
